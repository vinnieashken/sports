...
@section('content')
    <section id="standard" class="standard-area pt-5 homept mt-md-2 mt-lg-3 first">
        <div class="container mx-auto mt-lg-0 mt-md-5">
            ...
            <div class="row">
                <div class="offset-md-2 col-md-8 mb-3 col-sm-12">
                ...
                <div class="col span_1_of_3 mb-4 group">
                    ...
                    <div class="span_1_of_2_diff col">
                        <div class="text-center mb-2">
                            ...
                            <div id='div-gpt-ad-1485837217066-0' style='width:100%;margin:auto;' class="mx-auto">
                                <script>
