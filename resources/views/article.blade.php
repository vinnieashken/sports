                            ...
                            <div class="d-flex justify-content-between my-2">
                                <div class="mb-2">
                                    <div class="socialmedia-buttons btn-group">
                                        ...
                                        <a href="javascript:;" data-href="whatsapp://send?text={{ $article->title.' – '.urlencode( url()->current()) }}&utm-source=whatsapp&utm-medium=share&utm-campaign={{ $article->title }}" class="btn btn-whatsapp rounded-0 text-white d-block d-md-none" >
                                            <span class="fa fa-whatsapp"></span>
                                        </a>
