...
//        return;
        ...
        if($cookietool->enforceLogin())
        {
            ...
            $article->story = substr($article->story,0,400).' .... <p><a class="btn btn-success" data-toggle="modal" data-dismiss="modal" data-target="#loginModal" href="#">Login here</a> to read the full story</p>';
